...
class BookDirectoryTestSuite {
    ...
    @Nested
    @DisplayName("list of books with condition")
    ...
    @Nested
    @DisplayName("Books in hands of library user")
    class ListBookInHandsOf {
        @Test
        void testListBooksInHandsOfUserHasNone() {
            // Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            LibraryUser libraryUser = new LibraryUser("Marcin", "Pajak", "555555555");
